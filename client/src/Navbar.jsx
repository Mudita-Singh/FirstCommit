      ...
      <div className="navbar-container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
        ...
        {!authLoading && (
          user ? (
            ...
            <a 
              href={`${import.meta.env.VITE_API_URL || (import.meta.env.DEV ? 'http://localhost:5000' : '')}/api/auth/github?redirect=${encodeURIComponent(window.location.pathname + window.location.search)}`}
